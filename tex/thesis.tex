...
\newcommand{\myTitle}{Graph Neural Networks for Money Laundering detection\xspace}
\newcommand{\myName}{Martino Papa\xspace}
\newcommand{\myProf}{prof. Daniele Castellana\xspace}
\newcommand{\myTime}{Academic Year 2025-2026\xspace}
