...
for idx, combo in enumerate(combinations):
    ...
    if best_model_val_loss < best_val_loss:
        ...
        best_params = params
        model.save("saved_models/gagnn_best_model.pt")
...
model = GAGNN.load_saved("saved_models/gagnn_best_model.pt").to(device)
criterion = GAGNNLoss(c1=best_params['c1'], c2=best_params['c2'], c3=best_params['c3'])
...
if minibatches:
    ...
    Evaluator.evaluation_report(model, [d_dev], criterion, device)
